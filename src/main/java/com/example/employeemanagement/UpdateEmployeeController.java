...
public class UpdateEmployeeController implements Initializable {
    ...
    private void addEmployeeToUI(String firstName, String lastName, String salary, String city, String degree, String dateOfBirth) {
        ...
        updatebutton.setStyle("-fx-background-color: #FFBF00;-fx-text-fill: white;-fx-cursor: hand;");
        ...
        updatebutton.setOnAction(actionEvent -> {
            ...
            try {
                ...
                updateStage.setTitle("UpdateEmployee");
                updateStage.setScene(new Scene(root,1000,680));
                updateStage.show();
            } catch (IOException e) {
...
//            HBox employeerow = (HBox) updatebutton.getParent();
...
//            updateTextFile("C:\\Users\\GLB\\IdeaProjects\\EmployeeManagement\\src\\main\\employee.txt", employeeToDelete);
        ...
        employeeRow.getChildren().add(updatebutton);
        ...
        HBox.setMargin(updatebutton,new Insets(0,0,10,0));
